...
class _AuctionDetailPageState extends State<AuctionDetailPage> {
  ...
  void initState() {
    super.initState();
    _currentBid = widget.auction.startingPrice;
    _bidController.text = _currentBid.toString();
  }
            ...
            Stack(
              children: [
                CarouselSlider(
                  ...
                  items: widget.auction.itemImg.map((imageUrl) {
                    return Builder(
                ...
                Positioned(
                  ...
                  child: Row(
                    ...
                    children: widget.auction.itemImg.asMap().entries.map((entry) {
                      return Container(
                        width: 8.0,
                        height: 8.0,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          widget.auction.status.toUpperCase(),
                          style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        'Sold by ${widget.auction.merchantName}',
                  ...
                  // Item Details
                  _buildDetailRow('Category', widget.auction.category),
                  _buildDetailRow('Condition', widget.auction.condition),
                  _buildDetailRow('Quantity', '${widget.auction.remainingQuantity} of ${widget.auction.totalQuantity}'),
                  _buildDetailRow('Payment Duration', '${widget.auction.paymentDuration} hours'),
                  const SizedBox(height: 16),
                        ...
                        children: [
                          TextFormField(
                            ...
                            validator: (value) {
                              ...
                              if (bidAmount < _currentBid + widget.auction.bidIncrement) {
                                return 'Minimum bid increment is ${currencyFormat.format(widget.auction.bidIncrement)}';
                              }
                              return null;
                            },
                          ),
